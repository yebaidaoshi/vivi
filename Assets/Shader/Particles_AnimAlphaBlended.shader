// Legacy Shaders/Particles/Anim Alpha Blended (sharedassets13 path_id 351).
// Katana4_Smoke / realisticSmokeBurst-animAlpha uses this, not Additive.
Shader "Legacy Shaders/Particles/Anim Alpha Blended"
{
	...
	float4 AnimFrag(Varyings input) : SV_Target
	{
		...
		return 2.0 * input.color * _TintColor * tex;
	}
	ENDHLSL
